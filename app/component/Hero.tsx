...
const HeroSection = () => {
  return (
    ...
    <div className='  rounded-[12px] overflow-hidden'>
        <Image src='https://images.pexels.com/photos/1670766/pexels-photo-1670766.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1' fill className='object-cover object-center opacity-[60%] rounded-[12px]' alt='White sneakers'/>
